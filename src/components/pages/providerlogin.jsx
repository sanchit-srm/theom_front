                            ...
                            <div className="col-lg-6 right-login">
                                ...
                                <div className="theme-card authentication-right">
                                    ...
                                    <p>Sign up for a free account at our store. Registration is quick and easy. It
                                        allows you to be able to order from our shop. To start uploading service click
                                        register.</p>
                                    <Link to={`${process.env.PUBLIC_URL}/pages/providerregister`} className="btn btn-solid">
                                        {'Create an account'}
                                    </Link>
                                </div>
                            </div>
